...
The weighting candidate's eight-task exposed macro accuracy was 89.5821%, versus 89.43% for the Phase 4 reference. This small aggregate improvement does not compensate for failed condition and original numeric-development checks. It is not a result for the resampling candidate.
