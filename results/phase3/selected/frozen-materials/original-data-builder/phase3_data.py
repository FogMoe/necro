...
from necro.full_snapshots import ROOT as SNAPSHOTS
from necro.full_snapshots import rows as raw_rows
from necro.phase2_data import (
    example,
    extraction,
    numeric_rules,
    ordinal_rules,
...
from necro.source_isolation import Sources, signature, unseen_retrieval
...
def prepare():
    ...
    protocol = {
        ...
        "limitations": [
            ...
            "rare classes. Report coverage; do not claim all 60 classes are independently tested.",
            "Intent criterion cooking_query corrected using official training rows only.",
            "Public pretraining contamination is unknown. Synthetic rule templates are shared.",
            ...
            "official train/test qrels; this is not an official SciFact benchmark score.",
        ],
    }
